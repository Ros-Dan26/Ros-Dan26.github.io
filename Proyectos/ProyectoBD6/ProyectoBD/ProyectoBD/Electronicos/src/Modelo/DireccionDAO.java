...
public class DireccionDAO 
{
    ...
    public List MostrarDireccion()
    {
        ...
        try 
        {
            ...
            while(rs.next())
            {
                ...
                dir.setID_ESTADO(rs.getString("ID_ESTADO"));
                MostrarDir.add(dir);
            }
        } 
    ...
    {
        String sql = "INSERT INTO DIRECCION (ID_DIRECCION, ALCALDIA_MUNICIPIO, CP, CALLE, NUM_EXT, COLONIA, ID_ESTADO) "
                   + "VALUES(?,?,?,?,?,?,?)";
        try 
        {
            con = on.getConnection();
            ...
            ps.setString(1, dir.getID_DIRECCION());
            ...
            ps.setString(7, dir.getID_ESTADO());
            ps.execute();
            return true;
        } 
        catch (SQLException e) 
    ...
    {
        String sql = "UPDATE DIRECCION SET ALCALDIA_MUNICIPIO = ?, CP = ?, CALLE = ?, NUM_EXT = ?, COLONIA = ?, ID_ESTADO = ?"
                    + "WHERE ID_DIRECCION = ?";
        try 
        {
            ps = con.prepareStatement(sql);
            ...
            ps.setString(6, dir.getID_ESTADO());
            ps.setString(7, dir.getID_DIRECCION());
            ps.execute();
            return true;
