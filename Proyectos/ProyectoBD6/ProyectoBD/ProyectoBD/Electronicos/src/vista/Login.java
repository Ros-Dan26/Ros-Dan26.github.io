...
public class Login extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPasswordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 210, 130, -1));
        ...
        getContentPane().add(txtNombreUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 140, 130, -1));

        btnIniciarSesion.setBackground(new java.awt.Color(50, 50, 52));
        ...
        getContentPane().add(btnIniciarSesion, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 250, 100, -1));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 90, -1, 230));
    ...
    private void btnIniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarSesionActionPerformed
            ...
            boolean resultado = autenticado.verificarCredenciales(nombreUsuario, contrasena);

            if (resultado) {
                JOptionPane.showMessageDialog(null, "Inicio de sesión exitoso");
                // Mostrar el nuevo JFrame (Sistema) después de iniciar sesión
